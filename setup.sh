...
echo ""
echo "  Trust Kernel:"
echo "    ./target/release/tibet-bench        # Bifurcation crypto benchmark"
echo "    ./target/release/dual-kernel-demo   # Dual-kernel E2E pipeline"
echo "    ./target/release/cluster-paging-demo # RAM RAID + UPIP cluster paging"
echo "    ./target/release/portmux-xdp-demo   # XDP + PortMux hardening demo"
echo ""
